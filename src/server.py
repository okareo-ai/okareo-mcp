...
_INSTRUCTIONS = (
    ...
    "- Projects: list_projects, select_project, clone_project\n"
    ...
    "- New projects come from clone_project (server-side copy of an existing "
    "Project's Scenarios, dry-run first) or the Okareo web application.\n\n"
    "KEY WORKFLOWS:\n"
